...
from gr00t.data.dataset_robocasa import MetaRobocasaDataset, RobocasaDataset
...
from gr00t.model.transforms import DefaultDataCollatorGR00T, RobocasaDataCollatorGR00T
from gr00t.utils.experiment import CheckpointFormatCallback, RunNameLoggerCallback, safe_save_model_for_hf_trainer


class TrainRunnerRobocasa:
    def __init__(
        self,
        model: GR00T_N1,
        training_args: TrainingArguments,
        train_dataset: MetaRobocasaDataset,
        ...
        data_collator = data_collator_cls(
            ...
            **train_dataset.get_collator_kwargs(),
        )
    ...
    def create_trainer(
        ...
        # run name logger callback
        trainer.add_callback(RunNameLoggerCallback())
