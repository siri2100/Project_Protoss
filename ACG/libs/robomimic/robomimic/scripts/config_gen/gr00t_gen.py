...
def make_generator_helper(args):
    algo_name_short = "gr00t"

    args.abs_actions = True

    generator = get_generator(
        algo_name="gr00t",
        config_file=os.path.join(base_path, 'robomimic/exps/templates/gr00t.json'),
        args=args,
    ...
    generator.add_param(
        ...
        group=123456,
        values_and_names=[
            (get_robocasa_ds("single_stage", src="human", eval=["CloseDrawer", "OpenDrawer"], filter_key="50_demos"), "human-50"),  # ! todo: debugging
