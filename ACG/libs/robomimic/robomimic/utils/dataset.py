...
class SequenceDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        try:
            ...
            with open(os.path.expanduser(self.filter_by_attribute), 'r') as f:
                demos = json.load(f)[os.path.basename(self.hdf5_path)]
                demos = [f'demo_{i}' for i in demos]
            self.load_demo_info(demos=demos)
